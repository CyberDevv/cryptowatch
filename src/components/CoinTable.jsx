...
// tailwind styles
const TableWrapper = tw.div`divide-y-2 space-y-2 overflow-x-scroll`;
const TableGrid = tw.ul`min-w-[720px] grid justify-items-start divide-dark-gray items-center grid-template-columns[40px 0.3fr 2fr 1fr 0.7fr 0.7fr 0.7fr 1fr ]`;
