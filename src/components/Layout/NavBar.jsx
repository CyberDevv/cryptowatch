   ...
   return (
      <div css={[tw`relative h-6 lg:h-32`]}>
         <Nav className='navBar' ref={navBar}>
            <NavDiv>
               <div css={[tw`py-2 flex items-center justify-between`]}>
                  {/* Logo */}
                  <Link href='/' passHref>
                     <LogoAnchor>
                        <Logo />
...
const NavDiv = tw.div` max-w-[1920px] mx-auto w-full
 lg:flex items-center lg:(space-x-[55px]) xl:(space-x-[75px]) 2xl:(space-x-[115px]) transition-all duration-300`;
