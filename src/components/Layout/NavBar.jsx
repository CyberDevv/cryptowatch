...
// Tailwind styles
const Nav = tw.nav`mb-16 flex items-center lg:(px-10) pt-5 transition-all duration-300`;
const NavDiv = tw.div`max-w-[1920px] mx-auto w-full flex items-center xl:(space-x-[75px]) 2xl:(space-x-[115px]) transition-all duration-300`;
